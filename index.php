<?php 
    include ("lib_db.php");
    $sql="SELECT * FROM `btl` WHERE 1";
    $result=exec_select($sql);
    // print_r($result).die("áadasf");
    $sql="SELECT * FROM `chuyen_muc` WHERE 1";
    // print_r($sql).exit();
    $cm=select_list ($sql);
    // print_r($cm).exit();
?>
    ...
    <div class="shopee">
            ...
            <div class="grid">
                <nav class="header__navbar">
                    ...
                    <ul class="header__navbar-list">
                        ...
                        <li class="header__navbar-item">
                            <a href="dangki.php" class="header__navbar-item-link">Đăng Ký</a>
                        </li>
                ...
                <div class="header-with--search">
                    ...
                    <div class="header__search">
                        <div class="header__search-top">
                            <input type="text" class="header__search-input header__search-input-title" placeholder="Tìm kiếm"> 
                        ...
                        <div class="shopee-header__search-keywork">
                            ...
                            <a href="./danhmuc.php?id=<?php echo $item['id']?>" class="keyword-recommend">
                                <?php echo $item['name']?>
                            </a>
                            <?php } ?>
                        </div>   
        ...
        <div class="container" >
            ...
            <div class="banner-feature-wrapper">
                <!-- Banner -->
                <div class="container__banners">
                    <div class="container__banners-full">
                        <div class="container__banners-main">
                            <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                                ...
                                <div class="carousel-inner">
                                  <div class="carousel-item active">
                                    <img src="images/slide_bachhoatu1k.png" class="d-block w-100" alt="...">
                                  </div>
                                  <div class="carousel-item">
                                    <img src="images/slide_baove&taitao.png" class="d-block w-100" alt="...">
                                  </div>
                                  <div class="carousel-item">
                                    <img src="images/slide_daitiecbachhoa.png" class="d-block w-100" alt="...">
                                  </div>
                                  <div class="carousel-item">
                                    <img src="images/slide_hanghieu.png" class="d-block w-100" alt="...">
                                  </div>
                                  <div class="carousel-item">
                                    <img src="images/slide_hopquathuonghieu.png" class="d-block w-100" alt="...">
                                  </div>
                                  <div class="carousel-item">
                                    <img src="images/slide_khunggiosansale.png" class="d-block w-100" alt="...">
                                  </div>
                                  <div class="carousel-item">
                                    <img src="images/slide_mienphivanchuyen.png" class="d-block w-100" alt="...">
                                  </div>
                                  <div class="carousel-item">
                                    <img src="images/slide_muasamhanquoc.png" class="d-block w-100" alt="...">
                                  </div>
                                  <div class="carousel-item">
                                    <img src="images/slide_parkhangseo.png" class="d-block w-100" alt="...">
                                  </div>
                                  <div class="carousel-item">
                                    <img src="images/slide_shopeelive.png" class="d-block w-100" alt="...">
                                  </div>
                                  <div class="carousel-item">
                                    <img src="images/slide_shopeeluonbenban.png" class="d-block w-100" alt="...">
                                  </div>
                                  <div class="carousel-item">
                                    <img src="images/slide_shopeepay.png" class="d-block w-100" alt="...">
                                  </div>
                                  <div class="carousel-item">
                                    <img src="images/slide_sieusalebachhoa.png" class="d-block w-100" alt="...">
                                  </div>
                                </div>
                        ...
                        <div class="container_banners-right">
                            <div class="container_banners-right-top">
                                <a href="#">
                                    <img src="images/slide_shopeelive.png" alt="" class="container_banners-right-top-img">
                                </a>
                            </div>
                            <div class="container_banners-right-bottom">
                                 <a href="#">
                                     <img src="images/slide_shopeeluonbenban.png" alt="" class="container_banners-right-bottom-img">
                                 </a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="container_feature-wrapper">
                    <a href="#">
                        <div class="container_feature-items">
                            <div class="container_feature-icon">
                                <img src="images/sieuthidientu.png" alt="" class="container_feature-img">
                            </div>
                            <div class="container_feature-title">Tech Zone - Siêu Thị Điện Tử</div>
                        </div>
                    </a>
                    <a href="#">
                        <div class="container_feature-items">
                            <div class="container_feature-icon">
                                <img src="images/gicungre1k.png" alt="" class="container_feature-img">
                            </div>
                            <div class="container_feature-title">Gì Cũng Rẻ - Từ 1K</div>
                        </div>
                    </a>
                    <a href="#">
                        <div class="container_feature-items">
                            <div class="container_feature-icon">
                                <img src="images/hoanxu_extra.png" alt="" class="container_feature-img">
                            </div>
                            <div class="container_feature-title">Hoàn Xu 15% Mỗi Ngày</div>
                        </div>
                    </a>
                    <a href="#">
                        <div class="container_feature-items">
                            <div class="container_feature-icon">
                                <img src="images/napthe_hoadon.gif" alt="" class="container_feature-img">
                            </div>
                            <div class="container_feature-title">Nạp Thẻ, Hóa Đơn & E-voucher</div>
                        </div>
                    </a>
                    <a href="#">
                        <div class="container_feature-items">
                            <div class="container_feature-icon">
                                <img src="images/shopee_sogiday.gif" alt="" class="container_feature-img">
                            </div>
                            <div class="container_feature-title">Shopee Số Gì Đây</div>
                        </div>
                    </a>
                    <a href="#">
                        <div class="container_feature-items">
                            <div class="container_feature-icon">
                                <img src="images/freeship_extra.png" alt="" class="container_feature-img">
                            </div>
                            <div class="container_feature-title">Freeship Xtra</div>
                        </div>
                    </a>
                    <a href="#">
                        <div class="container_feature-items">
                            <div class="container_feature-icon">
                                <img src="images/hanghieu-50%.png" alt="" class="container_feature-img">
                            </div>
                            <div class="container_feature-title">Hàng Hiệu -50%</div>
                        </div>
                    </a>
                    <a href="#">
                        <div class="container_feature-items">
                            <div class="container_feature-icon">
                                <img src="images/hangquocte.png" alt="" class="container_feature-img">
                            </div>
                            <div class="container_feature-title">Hàng Quốc Tế</div>
                        </div>
                    </a>
                    <a href="#">
                        <div class="container_feature-items">
                            <div class="container_feature-icon">
                                <img src="images/shopee_pretium.png" alt="" class="container_feature-img">
                            </div>
                            <div class="container_feature-title">Shopee Premium</div>
                        </div>
                    </a>
                    <a href="#">
                        <div class="container_feature-items">
                            <div class="container_feature-icon">
                                <img src="images/yentammuahang.png" alt="" class="container_feature-img">
                            </div>
                            <div class="container_feature-title">Yên Tâm Mua Hàng</div>
                        </div>
                    </a>
                </div>
            </div>
            <!-- package banners -->
            <div class="package-banners">
                <img src="images/banners_dondautien0d.png" alt="" class="package-banners-img">
            </div>
            <!-- brand stuff-->
            <div class="container_brand-stuff">
                <div class="container_brand-stuff-top">
                    <img src="images/brand-stuff-top.jpg" alt="" class="container_brand-stuff-top-img">
                </div>
                <div class="container_brand-stuff-item">
                    <div class="container_brand-stuff-item-left">
                        <div class="container_brand-stuff-item-title">
                            <span class="selling-product">SẢN PHẨM BÁN CHẠY</span>
                            <a href="#" class="brand-stuff-see-more">Xem thêm
                                <i class="brand-stuff-next-right fas fa-angle-right"></i>
                            </a>
                        </div>
                        <div class="container_brand-stuff-item-product">
                            <a href="#" class="container_brand-stuff-item-product-one">
                                <div class="container_brand-stuff-item-product-one-img">
                                    <img src="images/banchay_l'oreal.png" alt="" class="brand-stuff-img">
                                </div>
                                <div class="container_brand-stuff-item-product-one-price">₫159.000</div>
                                <div class="container_brand-stuff-item-product-one-sale">
                                    <div class="brand-stuff-sale-background">
                                        <div class="brand-stuff-sale-title">
                            ...
                            <a href="#" class="container_brand-stuff-item-product-one">
                                <div class="container_brand-stuff-item-product-one-img">
                                    <img src="images/banchay_trasuachanchau.jpg" alt="" class="brand-stuff-img">
                                </div>
                                <div class="container_brand-stuff-item-product-one-price">₫109.000</div>
                                <div class="container_brand-stuff-item-product-one-sale">
                                    <div class="brand-stuff-sale-background">
                                        <div class="brand-stuff-sale-title">
                            ...
                            <a href="#" class="container_brand-stuff-item-product-one">
                                <div class="container_brand-stuff-item-product-one-img">
                                    <img src="images/banchay_vaseline.png" alt="" class="brand-stuff-img">
                                </div>
                                <div class="container_brand-stuff-item-product-one-price">₫199.000</div>
                                <div class="container_brand-stuff-item-product-one-sale">
                                    <div class="brand-stuff-sale-background">
                                        <div class="brand-stuff-sale-title">
                    ...
                    <div class="container_brand-stuff-item-right">
                            <div class="container_brand-stuff-item-title">
                                <span class="selling-product">THƯƠNG HIỆU NỔI BẬT</span>
                                <a href="#" class="brand-stuff-see-more">Xem thêm
                                    <i class="brand-stuff-next-right fas fa-angle-right"></i>
                                </a>
                            </div>
                            <div class="container_brand-stuff-item-product">
                                <a href="#" class="container_brand-stuff-item-product-one">
                                    <div class="container_brand-stuff-item-product-one-img">
                                        <img src="images/thuonghieu_loreal.jpg" alt="" class="brand-stuff-img-trademark">
                                    </div>
                                    <div class="container_brand-stuff-item-product-one-logo">
                                        <img src="images/logo-loreal.jpg" alt="" class="brand-stuff-logo">
                                    </div>
                                    <div class="dowto-full">
                                        <div class="container_brand-stuff-item-product-one-dowto">GIẢM ĐẾN 50%</div>
                                    </div>
                                    
                                </a>
                                <a href="#" class="container_brand-stuff-item-product-one">
                                    <div class="container_brand-stuff-item-product-one-img">
                                        <img src="images/thuonghieu_yody.jpg" alt="" class="brand-stuff-img-trademark">
                                    </div>
                                    <div class="container_brand-stuff-item-product-one-logo">
                                        <img src="images/logo-yody.jpg" alt="" class="brand-stuff-logo">
                                    </div>
                                    <div class="dowto-full">
                                        <div class="container_brand-stuff-item-product-one-dowto">GIẢM ĐẾN 50%</div>
                                    </div>
                                ...
                                <a href="#" class="container_brand-stuff-item-product-one">
                                    <div class="container_brand-stuff-item-product-one-img">
                                        <img src="images/thuonghieu_paulachoice.jpg" alt="" class="brand-stuff-img-trademark">
                                    </div>
                                    <div class="container_brand-stuff-item-product-one-logo">
                                        <img src="images/logo-paulachoice.jpg" alt="" class="brand-stuff-logo">
                                    </div>
                                    <div class="dowto-full">
                                        <div class="container_brand-stuff-item-product-one-dowto">GIẢM ĐẾN 30%</div>
                                    </div>
                ...
                <div class="container_brand-stuff-bottom">
                    <img src="images/brand-stuff-bot.jpg" alt="" class="container_brand-stuff-bottom-img">
                </div>
            </div>

            <!-- Full-product -->
            <div class="container_full-product">
                <!-- catedory -->
                <div class="category">
                    <div class="category-title">
                        <div class="category-title-header">
                            <div class="category-title-header-list">DANH MỤC</div>
                        </div>
                    </div>
                    <!--category-content -->
                    <div class="category-content">
                        <a href="#" class="category-content-item">
                            <div class="category-content-item-list">
                                <div class="category-content-item-list">
                                    <div class="category-content-item-list-img">
                                        <img src="images/category_thoitrangnam.png" alt="" class="category-img">
                                    </div>
                                    <div class="category-content-item-list-title">
                                        Thời Trang Nam
                                    </div>
                                </div>
                        ...
                        <a href="#" class="category-content-item">
                            <div class="category-content-item-list">
                                <div class="category-content-item-list">
                                    <div class="category-content-item-list-img">
                                        <img src="images/category_phukiendienthoai.png" alt="" class="category-img">
                                    </div>
                                    <div class="category-content-item-list-title">
                                        Điện Thoại & Phụ Kiện
                                    </div>
                        ...
                        <a href="#" class="category-content-item">
                            <div class="category-content-item-list">
                                <div class="category-content-item-list">
                                    <div class="category-content-item-list-img">
                                        <img src="images/category_thietbidientu.png" alt="" class="category-img">
                                    </div>
                                    <div class="category-content-item-list-title">
                                        Thiết Bị Điện Tử
                                    </div>
                        ...
                        <a href="#" class="category-content-item">
                            <div class="category-content-item-list">
                                <div class="category-content-item-list">
                                    <div class="category-content-item-list-img">
                                        <img src="images/category_maytinhlaptop.png" alt="" class="category-img">
                                    </div>
                                    <div class="category-content-item-list-title">
                                        Máy Tính & Laptop
                                    </div>
                        ...
                        <a href="#" class="category-content-item">
                            <div class="category-content-item-list">
                                <div class="category-content-item-list">
                                    <div class="category-content-item-list-img">
                                        <img src="images/category_mayanh.png" alt="" class="category-img">
                                    </div>
                                    <div class="category-content-item-list-title">
                        ...
                        <a href="#" class="category-content-item">
                            <div class="category-content-item-list">
                                <div class="category-content-item-list">
                                    <div class="category-content-item-list-img">
                                        <img src="images/category_dongho.png" alt="" class="category-img">
                                    </div>
                                    <div class="category-content-item-list-title">
                                        Đồng Hồ
                                    </div>
                        ...
                        <a href="#" class="category-content-item">
                            <div class="category-content-item-list">
                                <div class="category-content-item-list">
                                    <div class="category-content-item-list-img">
                                        <img src="images/category_giaydepnam.png" alt="" class="category-img">
                                    </div>
                                    <div class="category-content-item-list-title">
                                        Giày Dép Nam
                                    </div>
                        ...
                        <a href="#" class="category-content-item">
                            <div class="category-content-item-list">
                                <div class="category-content-item-list">
                                    <div class="category-content-item-list-img">
                                        <img src="images/category_thietbigiadung.png" alt="" class="category-img">
                                    </div>
                                    <div class="category-content-item-list-title">
                        ...
                        <a href="#" class="category-content-item">
                            <div class="category-content-item-list">
                                <div class="category-content-item-list">
                                    <div class="category-content-item-list-img">
                                        <img src="images/category_thethaodulich.png" alt="" class="category-img">
                                    </div>
                                    <div class="category-content-item-list-title">
                                        Thể Thao & Du Lịch
                                    </div>
                        ...
                        <a href="#" class="category-content-item">
                            <div class="category-content-item-list">
                                <div class="category-content-item-list">
                                    <div class="category-content-item-list-img">
                                        <img src="images/category_xedapotoxemay.png" alt="" class="category-img">
                                    </div>
                                    <div class="category-content-item-list-title">
                                        Ô Tô & Xe Máy & Xe Đạp
                                    </div>
                        ...
                        <a href="#" class="category-content-item">
                            <div class="category-content-item-list">
                                <div class="category-content-item-list">
                                    <div class="category-content-item-list-img">
                                        <img src="images/category_thoitrangnu.png" alt="" class="category-img">
                                    </div>
                                    <div class="category-content-item-list-title">
                                        Thời Trang Nữ
                                    </div>
                        ...
                        <a href="#" class="category-content-item">
                            <div class="category-content-item-list">
                                <div class="category-content-item-list">
                                    <div class="category-content-item-list-img">
                                        <img src="images/category_me&be.png" alt="" class="category-img">
                                    </div>
                                    <div class="category-content-item-list-title">
                                        Mẹ & Bé
                                    </div>
                        ...
                        <a href="#" class="category-content-item">
                            <div class="category-content-item-list">
                                <div class="category-content-item-list">
                                    <div class="category-content-item-list-img">
                                        <img src="images/category_thietbidoisong.png" alt="" class="category-img">
                                    </div>
                                    <div class="category-content-item-list-title">
                                        Nhà Cửa & Đời Sống
                                    </div>
                        ...
                        <a href="#" class="category-content-item">
                            <div class="category-content-item-list">
                                <div class="category-content-item-list">
                                    <div class="category-content-item-list-img">
                                        <img src="images/category_sacdep.png" alt="" class="category-img">
                                    </div>
                                    <div class="category-content-item-list-title">
                                        Sắc Đẹp
                                    </div>
                        ...
                        <a href="#" class="category-content-item">
                            <div class="category-content-item-list">
                                <div class="category-content-item-list">
                                    <div class="category-content-item-list-img">
                                        <img src="images/category_suckhoe.png" alt="" class="category-img">
                                    </div>
                                    <div class="category-content-item-list-title">
                                        Sức Khỏe
                                    </div>
                        ...
                        <a href="#" class="category-content-item">
                            <div class="category-content-item-list">
                                <div class="category-content-item-list">
                                    <div class="category-content-item-list-img">
                                        <img src="images/category_giaydepnu.png" alt="" class="category-img">
                                    </div>
                                    <div class="category-content-item-list-title">
                                        Giày Dép Nữ
                                    </div>
                        ...
                        <a href="#" class="category-content-item">
                            <div class="category-content-item-list">
                                <div class="category-content-item-list">
                                    <div class="category-content-item-list-img">
                                        <img src="images/category_tuivinu.png" alt="" class="category-img">
                                    </div>
                                    <div class="category-content-item-list-title">
                                        Túi Ví Nữ
                                    </div>
                        ...
                        <a href="#" class="category-content-item">
                            <div class="category-content-item-list">
                                <div class="category-content-item-list">
                                    <div class="category-content-item-list-img">
                                        <img src="images/category_trangsucnu.png" alt="" class="category-img">
                                    </div>
                                    <div class="category-content-item-list-title">
                        ...
                        <a href="#" class="category-content-item">
                            <div class="category-content-item-list">
                                <div class="category-content-item-list">
                                    <div class="category-content-item-list-img">
                                        <img src="images/category_bachhoaonline.png" alt="" class="category-img">
                                    </div>
                                    <div class="category-content-item-list-title">
                                        Bách Hóa Online
                                    </div>
                        ...
                        <a href="#" class="category-content-item">
                            <div class="category-content-item-list">
                                <div class="category-content-item-list">
                                    <div class="category-content-item-list-img">
                                        <img src="images/category_nhasachonline.png" alt="" class="category-img">
                                    </div>
                                    <div class="category-content-item-list-title">
                                        Nhà Sách Online
                                    </div>
                ...
                <div class="flash-sale">
                    <div class="flash-sale-header">
                        <div class="flash-sale-header-title">
                            <div class="flash-sale-header-title-item">
                                <div class="flash-sale-header-title-item-sale">
                                    <img src="images/flash-sale.png" alt="" class="flash-sale-img">
                                </div>
                                <div class="flash-sale-header-title-item-clock">

                                </div>
                            </div>
                        </div>    
                        <div class="flash-sale-header-link">
                            <a href="#" class="flash-sale-header-link-seeall">Xem Tất Cả
                                <i class="flash-sale-next-right fas fa-angle-right"></i>
                            </a>
                        </div>
                    ...
                    <div class="flash-sale-content">
                            <a href="#" class="flash-sale-content-product">
                                <div class="flash-sale-content-product-img">
                                    <img src="images/flash-sale/durex.png" alt="" class="flash-sale-product-img">
                                </div>
                                <div class="flash-sale-content-product-price">
                                    <span class="flash-sale-price-dollar">đ</span>
                                    <span class="flash-sale-price-number">129.000</span>
                                </div>
                                <div class="flash-sale-content-product-sale">
                            ...
                            <a href="#" class="flash-sale-content-product">
                                <div class="flash-sale-content-product-img">
                                    <img src="images/flash-sale/flash_sale-megajumbo.jpg" alt="" class="flash-sale-product-img">
                                </div>
                                <div class="flash-sale-content-product-price">
                                    <span class="flash-sale-price-dollar">đ</span>
                                    <span class="flash-sale-price-number">399.000</span>
                                </div>
                                <div class="flash-sale-content-product-sale">
                                    <div class="flash-sale-background">
                                        <div class="flash-sale-title">
                            ...
                            <a href="#" class="flash-sale-content-product">
                                <div class="flash-sale-content-product-img">
                                    <img src="images/flash-sale/focallure.jpg" alt="" class="flash-sale-product-img">
                                </div>
                                <div class="flash-sale-content-product-price">
                                    <span class="flash-sale-price-dollar">đ</span>
                                    <span class="flash-sale-price-number">159.000</span>
                                </div>
                                <div class="flash-sale-content-product-sale">
                                    <div class="flash-sale-background">
                                        <div class="flash-sale-title">
                            ...
                            <a href="#" class="flash-sale-content-product">
                                <div class="flash-sale-content-product-img">
                                    <img src="images/flash-sale/hadalabo.png" alt="" class="flash-sale-product-img">
                                </div>
                                <div class="flash-sale-content-product-price">
                                    <span class="flash-sale-price-dollar">đ</span>
                                    <span class="flash-sale-price-number">260.000</span>
                                </div>
                                <div class="flash-sale-content-product-sale">
                                    <div class="flash-sale-background">
                                        <div class="flash-sale-title">
                            ...
                            <a href="#" class="flash-sale-content-product">
                                <div class="flash-sale-content-product-img">
                                    <img src="images/flash-sale/hoodie.jpg" alt="" class="flash-sale-product-img">
                                </div>
                                <div class="flash-sale-content-product-price">
                                    <span class="flash-sale-price-dollar">đ</span>
                                    <span class="flash-sale-price-number">299.000</span>
                                </div>
                                <div class="flash-sale-content-product-sale">
                                    <div class="flash-sale-background">
                                        <div class="flash-sale-title">
                            ...
                            <a href="#" class="flash-sale-content-product">
                                <div class="flash-sale-content-product-img">
                                    <img src="images/flash-sale/laneige.png" alt="" class="flash-sale-product-img">
                                </div>
                                <div class="flash-sale-content-product-price">
                                    <span class="flash-sale-price-dollar">đ</span>
                                    <span class="flash-sale-price-number">545.000</span>
                                </div>
                                <div class="flash-sale-content-product-sale">
                                    <div class="flash-sale-background">
                                        <div class="flash-sale-title">
                ...
                <div class="skinny-banner">
                    <a href="#" class="skinny-banner-full">
                        <div class="skinny-banner-full-img">
                            <img src="images/skinny_senka.jpg" alt="" class="skinny-img">
                        </div>
                    </a>
                    <a href="#" class="skinny-banner-full">
                        <div class="skinny-banner-full-img">
                            <img src="images/skinny_sanma0d.jpg" alt="" class="skinny-img">
                        </div>
                    </a>
                    <a href="#" class="skinny-banner-full">
                        <div class="skinny-banner-full-img">
                            <img src="images/skinny_moony.jpg" alt="" class="skinny-img">
                        </div>
                    </a> 
                </div>
                <!-- shopee mall -->
                <div class="shopee-mall">
                    <div class="shopee-mall-header">
                        <div class="shopee-mall-header-title">
                            <div class="shopee-mall-header-title-shopee-mall">
                                <a href="#" class="shopee-mall-header-title-letter">SHOPEE MALL</a>
                            </div>
                            <div class="shopee-mall-header-title-main">
                                <div class="shopee-mall-header-title-main-one">
                                    <img src="images/shopee-mall-undo.png" alt="" class="shopee-mall-icon">
                                    7 Ngày Miễn Phí Trả Hàng
                                </div>
                                <div class="shopee-mall-header-title-main-one">
                                    <img src="images/shopee-mall-car.png" alt="" class="shopee-mall-icon">
                                    Hàng Chính Hãng 100%
                                </div>
                                <div class="shopee-mall-header-title-main-one">
                                    <img src="images/shopee-mall-oke.png" alt="" class="shopee-mall-icon">
                                    Miễn Phí Vận Chuyển
                                </div>
                            </div>
                        </div>
                        <div class="shopee-mall-header-link">
                            <button class="shopee-mall-header-link-btn">
                                <a href="#" class="shopee-mall-header-link-btn-seeall">
                                    <div class="shopee-mall-header-link-btn-seeall-title">Xem Tất Cả
                                        <i class="shopee-mall-next fas fa-chevron-circle-right"></i>  
                                    </div>
                                </a>
                            </button>
                        </div>
                    ...
                    <div class="shopee-mall-content">
                        <div class="shopee-mall-content-slide">
                            <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
                                ...
                                <div class="carousel-inner">
                                  <div class="carousel-item active">
                                    <img src="images/slide_shopee-mall-1.png" class="d-block w-100" alt="...">
                                  ...
                                  <div class="carousel-item">
                                    <img src="images/slide_shopee-mall-2.png" class="d-block w-100" alt="...">
                                    <div class="carousel-caption d-none d-md-block">
                                      <h5></h5>
                                      <p></p>
                                    </div>
                                  ...
                                  <div class="carousel-item">
                                    <img src="images/slide_shopee-mall-3.png" class="d-block w-100" alt="...">
                                    <div class="carousel-caption d-none d-md-block">
                                      <h5></h5>
                                      <p></p>
                                    </div>
                                  ...
                                  <div class="carousel-item">
                                    <img src="images/slide_shopee-mall-4.png" class="d-block w-100" alt="...">
                                    <div class="carousel-caption d-none d-md-block">
                                      <h5></h5>
                                      <p></p>
                                    </div>
                                  ...
                                  <div class="carousel-item">
                                    <img src="images/slide_shopee-mall-5.png" class="d-block w-100" alt="...">
                                    <div class="carousel-caption d-none d-md-block">
                                      <h5></h5>
                                      <p></p>
                                    </div>
                                  ...
                                  <div class="carousel-item">
                                    <img src="images/slide_shopee-mall-6.png" class="d-block w-100" alt="...">
                                    <div class="carousel-caption d-none d-md-block">
                                      <h5></h5>
                                      <p></p>
                                    </div>
                                  ...
                                  <div class="carousel-item">
                                    <img src="images/slide_shopee-mall-7.png" class="d-block w-100" alt="...">
                                    <div class="carousel-caption d-none d-md-block">
                                      <h5></h5>
                                      <p></p>
                                    </div>
                        ...
                        <div class="shopee-mall-content-product">
                            <a href="#" class="shopee-mall-content-product-link">
                                <div class="shopee-mall-content-product-link-img">
                                    <img src="images/shopee-mall-larocheposay.png" alt="" class="shopee-mall-content-img">
                                </div>
                                
                                <div class="shopee-mall-content-product-link-title">Da khỏe sạch mụn</div>
                            </a>
                            <a href="#" class="shopee-mall-content-product-link">
                                <div class="shopee-mall-content-product-link-img">
                                    <img src="images/shopee-mall-tefat.png" alt="" class="shopee-mall-content-img">
                                </div>
                                
                                <div class="shopee-mall-content-product-link-title">Vua bếp Tefal</div>
                            </a>
                            <a href="#" class="shopee-mall-content-product-link">
                                <div class="shopee-mall-content-product-link-img">
                                    <img src="images/shopee-mall-colosmulti.png" alt="" class="shopee-mall-content-img">
                                </div>
                                
                                <div class="shopee-mall-content-product-link-title">Sữa sịn quà xinh</div>
                            </a>
                            <a href="#" class="shopee-mall-content-product-link">
                                <div class="shopee-mall-content-product-link-img">
                                    <img src="images/shopee-mall-unilever.png" alt="" class="shopee-mall-content-img">
                                </div>
                                
                                <div class="shopee-mall-content-product-link-title">Ưu đãi đến 34%</div>
                            </a>
                            <a href="#" class="shopee-mall-content-product-link">
                                <div class="shopee-mall-content-product-link-img">
                                    <img src="images/shopee-mall-p&g.png" alt="" class="shopee-mall-content-img">
                                </div>
                                
                                <div class="shopee-mall-content-product-link-title">Săn quà cùng P&G</div>
                            </a>
                            <a href="#" class="shopee-mall-content-product-link">
                                <div class="shopee-mall-content-product-link-img">
                                    <img src="images/shopee-mall-pampers.png" alt="" class="shopee-mall-content-img">
                                </div>
                            ...
                            <a href="#" class="shopee-mall-content-product-link">
                                <div class="shopee-mall-content-product-link-img">
                                    <img src="images/shopee-mall-focallure.png" alt="" class="shopee-mall-content-img">
                                </div>
                                
                                <div class="shopee-mall-content-product-link-title">Giảm đến 50%</div>
                            </a>
                            <a href="#" class="shopee-mall-content-product-link">
                                <div class="shopee-mall-content-product-link-img">
                                    <img src="images/shopee-mall-deli.png" alt="" class="shopee-mall-content-img">
                                </div>
                                
                                <div class="shopee-mall-content-product-link-title">Deli giảm đến 50%</div>
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="search-trending">
                    <div class="search-trending-header">
                        <div class="search-trending-header-title">
                            <span>XU HƯỚNG TÌM KIẾM</span>
                        </div>
                        <div class="search-trending-header-link">
                            <button class="search-trending-header-link-btn">
                                <i class="search-trending-icon fas fa-sync-alt"></i>
                                Xem Thêm
                            </button>
                        </div>
                    </div>
                    <div class="search-trending-content">
                        <a href="#" class="search-trending-content-product">
                            <div class="search-trending-content-product-title">
                                <div class="search-trending-content-product-title-link">
                                    <div class="search-trending-content-product-title-link-top">Tai-nghe Bluetooth</div>
                                    <div class="search-trending-content-product-title-link-bot">6k+ sản phẩm</div>
                                </div>
                            </div>
                            <div class="search-trending-content-product-img">
                                <img src="images/search-trending-vivan.jpg" alt="" class="search-trending-img">
                            </div>
                        </a>
                        <a href="#" class="search-trending-content-product">
                            <div class="search-trending-content-product-title">
                                <div class="search-trending-content-product-title-link">
                                    <div class="search-trending-content-product-title-link-top">Váy Trắng</div>
                                    <div class="search-trending-content-product-title-link-bot">6k+ sản phẩm</div>
                                </div>
                            </div>
                            <div class="search-trending-content-product-img">
                                <img src="images/search-trending-dress.jpg" alt="" class="search-trending-img">
                            </div>
                        </a>
                        <a href="#" class="search-trending-content-product">
                            <div class="search-trending-content-product-title">
                                <div class="search-trending-content-product-title-link">
                                    <div class="search-trending-content-product-title-link-top">Khẩu-Trang 3d</div>
                                    <div class="search-trending-content-product-title-link-bot">6k+ sản phẩm</div>
                                </div>
                            </div>
                            <div class="search-trending-content-product-img">
                                <img src="images/search-trending-3dmask.jpg" alt="" class="search-trending-img">
                            </div>
                        </a>
                        <a href="#" class="search-trending-content-product">
                            <div class="search-trending-content-product-title">
                                <div class="search-trending-content-product-title-link">
                                    <div class="search-trending-content-product-title-link-top">Son Nội-địa-trung</div>
                                    <div class="search-trending-content-product-title-link-bot">6k+ sản phẩm</div>
                                </div>
                            </div>
                            <div class="search-trending-content-product-img">
                                <img src="images/search-trending-mixdair.jpg" alt="" class="search-trending-img">
                            </div>
                        </a>
                        <a href="#" class="search-trending-content-product">
                            <div class="search-trending-content-product-title">
                                <div class="search-trending-content-product-title-link">
                                    <div class="search-trending-content-product-title-link-top">Kệ Gỗ</div>
                                    <div class="search-trending-content-product-title-link-bot">6k+ sản phẩm</div>
                                </div>
                            </div>
                            <div class="search-trending-content-product-img">
                                <img src="images/search-trending-sib-decor.jpg" alt="" class="search-trending-img">
                            </div>
                        </a>
                ...
                <div class="product-today">
                    <div>
                        <div class="container">
                            <nav class="product-today-header">
                                <ul class="product-today-header-title">
                                    <li class="product-today-header-title-main product-today-header-main-active">
                                        <div class="product-today-header-underline"></div>
                                        <div class="product-today-header-text">
                                            <span>GỢI Ý HÔM NAY</span>
                                        </div>
                                    </li>
                                    <li class="product-today-header-title-main">
                                        <div class="product-today-header-underline"></div>
                                        <div class="product-today-header-text">
                                            <img src="images/product/header.png" alt="">
                                        </div>
                                    </li>
                                </ul>
                            </nav>
                            <div class="product-today-main">
                                <div class="row">
                                    <?php foreach($result as $item ){ ?>
                                    <div class="col col-12 col-xl-2 col-lg-3 col-md-4 col-sm-6">
                                        <a href="chitiet.php?id=<?php echo $item["id"]?>" class="product-today-main-link">
                                            <div class="product-today-main-item">
                                                <div class="product-today-main-images">
                                                    <img src="<?php echo $item["img"]?>" alt="" class="product-today-img">  
                                                    <div class="product-today-main-ads">Tài Trợ</div>
                                                </div>
                                                <h4 class="product-today-main-name"><?php echo $item["name"]?></h4>
                                                <div class="product-today-main-discount">
                                                    <div class="product-today-main-discount-title">
                                                    <?php echo $item["discount"]?>
                                                    </div>
                                                </div>
                                                <div class="product-today-main-price">
                                                    <div class="product-today-main-price-all">
                                                        <span class="product-today-main-price-letter">đ</span>
                                                        <span class="product-today-main-price-number">
                                                        <?php echo $item["price"]?>
                                                        </span>
                                                    </div>
                                                    <div class="product-today-main-sold-number"><?php echo $item["sold"]?></div>
                                                </div>
                                                <div class="product-today-main-favourite"><?php echo $item["favourite"]?></div>
                                                <div class="product-today-main-sale">
                                                    <span class="product-today-main-sale-off"><?php echo $item["sale"]?></span>
                                                    <span class="product-today-main-sale-letter">Giảm</span>
                                                </div>
                                                <div class="product-today-main-hidden">Tìm sản phẩm tương tự</div>
                                            </div>
                                        </a>
                                    </div>
                                    <?php } ?>
                                ...
                                <a href="#" class="product-today-main-next">
                                    <div class="product-today-main-next-see-all">
                                        <div class="product-today-main-next-see-all-btn">Xem Thêm</div>
                                    </div>
                                </a>
                            </div>
                        </div>
