<?php
	...
	$sql = "select * from btl {$cond} order by id desc
	 limit 150";
	// echo $sql;exit();
            ...
            <!-- Banner and future -->                      
                            <div class="product-today-main">
                                ...
                                <h1>Quản lý sản phẩm</h1>
                                    ...
                                    <tr>
                                    ...
                                    </tr> <?php foreach ($result as $item) {?> <tr>
                                        ...
                                        <td> <?php echo $item['favourite'];?> </td>
                                        <td> <?php echo $item['sale'];?> </td>
                                        <td>
                                        <a href="edit.php?id=
					                        <?php echo $item['id'];?>">Edit </a>
                                        </td>
                                        <td>
                                        <a href="delete.php?id=
					                        <?php echo $item['id'];?>">Delete </a>
                                        </td>
                                    </tr> <?php } ?>
                                    </table>
                                    <br />
