    ...
    <div class="shopee">
        ...
        <div class="container-login-background">
            <div class="container-login-background-images" style="background-image: url(images/login/background.png); background-size: cover; background-repeat: no-repeat; background-position: center center;">
                <form action="dangnhap_submit.php" method="POST" role="form">
                    <div class="container-login">
                        ...
                        <div class="login-mid">
                            <div class="login-mid-account">
                                <div class="login-mid-account-text">
                                    <input class="login-mid-account-input" type="text" placeholder="Email/Số điện thoại/Tên đăng nhập" autocomplete="on" name="username" maxlength="128" value >
                           ...
                           <button class="login-mid-btn btn-login" type="submit" name="submit">
                               ĐĂNG NHẬP
                           </button>
                        ...
                        <div class="login-bot">
                            <div class="login-bot-text">
                                ...
                                <a href="dangki.php" class="login-bot-text-link">
                                    Đăng ký
                                </a>
                            </div>
                        </div>
