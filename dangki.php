        ...
        <nav class="header-login">
            <div class="header-login-flex">
                <div class="header-login-left">
                    ...
                    <div class="header-login-left-text">Đăng nhập</div>
                </div>
                <a href="#" class="header-login-right">Cần trợ giúp?</a>
            </div>
        </nav>
        <div class="container-login-background">
            <div class="container-login-background-images" style="background-image: url(images/login/background.png); background-size: cover; background-repeat: no-repeat; background-position: center center;">
                <div >
                    <div class="container-login">
                        <div class="login-top">
                            <div class="login-top-item">
                                <div class="login-top-item-text">Đăng Nhập</div>
                                <div class="login-top-item-code">
                                    <div class="login-top-item-code-left">
                                        Đăng nhập với mã QR
                                    </div>
                                    <a href="#" class="login-top-item-code-right">
                                        <svg width="40" height="40" fill="none" class="_3F92IZ">
                        ...
                        <div class="login-mid">
                            <form action="dangki_submit.php" method="POST" role="form">
                                    <div class="login-mid-account">
                                        <div class="login-mid-account-text">
                                            <input class="login-mid-account-input" type="text" placeholder="Email/Số điện thoại" autocomplete="on" name="username" maxlength="128" value >

                                        </div>  
                                        <div class="login-mid-account-add"></div>
                                    </div>
                                    <div class="login-mid-password">
                                        <div class="login-mid-account-text">
                                            <input class="login-mid-account-input" type="password" placeholder="Mật khẩu" autocomplete="on" name="password" maxlength="128" value >
                                    ...
                                    <div class="login-mid-password">
                                        <div class="login-mid-account-text">
                                            <input class="login-mid-account-input" type="password" placeholder="Nhập lại mật khẩu" autocomplete="on" name="repassword" maxlength="128" value >

                                        </div>  
                                        <div class="login-mid-account-add"></div>
                                    </div>
                                    <button name="submit" class="login-mid-btn btn-login" type="submit">
                                        ĐĂNG KÍ
                                    </button>
                            </form>
                            
                           <div class="login-mid-forget">
                                <a href="#" class="login-mid-forget-text">Quên mật khẩu</a>
                                <a href="#" class="login-mid-forget-text">Đăng nhập với SMS</a>
                           </div>
                           <div class="login-mid-app">
                               <div class="login-mid-app-or">
                                   <div class="login-mid-app-or-line"></div>
                                   <span class="login-mid-app-or-text">HOẶC</span>
                                   <div class="login-mid-app-or-line"></div>
                               </div>
                               <div class="login-mid-app-link">
                                   <button class="login-mid-app-btn btn-blue">
                                        <i class="login-mid-app-icon fab fa-facebook"></i>
                                        <div class="login-mid-app-label">Facebook</div>
                                   </button>
                                   <button class="login-mid-app-btn btn-blue">
                                        <div class="login-mid-app-btn-icon">
                                            <i class="login-mid-app-icon-google fab fa-google"></i>
                                        </div>
                                        <div class="login-mid-app-label">Google</div>
                                    </button>
                                    <button class="login-mid-app-btn btn-black">
                                        <i class="login-mid-app-icon fab fa-apple"></i>
                                        <div class="login-mid-app-label">Apple</div>
                                    </button>
                               </div>
                           </div>
                        </div>
