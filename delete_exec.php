            ...
            <div class="container_full-product">
                ...
                <div class="top-search">
                    <div class="top-search-header">
                        <div class="top-search-header-title">
                            <span class="top-search-header-title-letter">
                                TÌM KIẾM HÀNG ĐẦU
                            </span>
                        </div>
                        <a href="#" class="top-search-header-link">
                            <button class="top-search-seeall">
                                Xem Tất Cả
                                <i class="top-search-next-right fas fa-angle-right"></i>
                            </button>
                        </a>
                    </div>
