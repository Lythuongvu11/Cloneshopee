<?php 
	...
	if ($id < 1) return;
	//2. tao sql
	$sql = "select * from btl where id=" .$id;
	//echo "sql=[$sql]";exit();
	//3. thuc thi, select list or one
    ...
    <div class="shopee">
                ...
                <div class="header-with--search">
                    ...
                    <div class="header__search">
                        <div class="header__search-top">
                            <input type="text" class="header__search-input header__search-input-title" placeholder="Áo Khoác"> 
        ...
        <div class="container-chitiet">
            <div class="chitiet-item">
                <a href="#" class="chitiet-item-text-blue">Shopee</a>
                <i class="chitiet-item-icon fas fa-angle-right"></i>
                <a href="#" class="chitiet-item-text">Women Clothes</a>
                <i class="chitiet-item-icon fas fa-angle-right"></i>
                <a href="#" class="chitiet-item-text">Hoodies & Sweatshirts</a>
                <i class="chitiet-item-icon fas fa-angle-right"></i>
                <a href="#" class="chitiet-item-text">Hoodies</a>
                <i class="chitiet-item-icon fas fa-angle-right"></i>
                <a href="#" class="chitiet-item-text"><?php echo $result["name"] ?></a>
            </div>
            <div class="chitiet-product">
                <div class="chitiet-product-left">
                    <div class="chitiet-product-left-album">
                        <div class="chitiet-product-album">
                            <div class="chitiet-product-album-images-img">
                                <img src="images/chitiet/backgroud-freeship.png" alt="" class="chitiet-img" style="background-image: url(<?php echo $result["img"] ?>);background-size: 100%;">
                            </div>
                        </div>
                        <div class="chitiet-product-slide">
                            <div class="chitiet-product-slide-images">
                                <img src="<?php echo $result["img"] ?>" alt="" class="chitiet-product-slide-img" style="background-image: url(images/chitiet/aokhoac1-small.jpg);background-size: 100%;">
                            </div>
                            <div class="chitiet-product-slide-images">
                                <img src="<?php echo $result["imgsmall1"] ?>" alt="" class="chitiet-product-slide-img">
                            </div>
                            <div class="chitiet-product-slide-images">
                                <img src="<?php echo $result["imgsmall2"] ?>" alt="" class="chitiet-product-slide-img">
                            </div>
                            <div class="chitiet-product-slide-images">
                                <img src="<?php echo $result["imgsmall3"] ?>" alt="" class="chitiet-product-slide-img">
                            </div>
                            <div class="chitiet-product-slide-images">
                                <img src="<?php echo $result["imgsmall1"] ?>" alt="" class="chitiet-product-slide-img">
                            </div>
                ...
                <div class="chitiet-product-right">
                    <div class="chitiet-product-right-flex">
                        <div class="chitiet-product-right-header">
                            <div class="chitiet-product-right-header-like"><?php echo $result["favourite"] ?></div>
                            <span><?php echo $result["name"] ?></span>
                        </div>
                        <div class="chitiet-product-right-rating">
                            
                            <div class="chitiet-product-right-rating-sold">
                                <div class="chitiet-product-right-rating-sold-number"><?php echo $result["sold"] ?></div>
                               
                            </div>
                        </div>
                        <div class="chitiet-product-right-price">
                            <div class="chitiet-product-right-price-flex">
                                
                                <div class="chitiet-product-right-price-now">
                                    <div class="chitiet-product-right-price-now-number"><?php echo $result["price"] ?></div>
                                    <div class="chitiet-product-right-price-now-sale">40% GIẢM</div>
                                </div>
                            </div>
                        </div>
                        <div class="chitiet-product-right-transport">
                            <div class="chitiet-product-right-transport-flex">
                                <div class="chitiet-product-right-transport-top">
                                    <label class="chitiet-product-right-transport-top-label">Vận chuyển</label>
                                    <div class="chitiet-product-right-transport-top-item">
                                        <div class="chitiet-product-right-transport-top-item-free">
                                            <div class="chitiet-product-right-transport-top-item-free-top">
                                                <img src="images/chitiet/free.png" alt="" class="chitiet-product-right-transport-top-item-img">
                                                Miễn phí vận chuyển
                                            </div>
                                            <div class="chitiet-product-right-transport-top-item-free-text">
                                                Miễn phí vận chuyển cho đơn hàng trên ₫50.000
                                            </div>
                                        </div>
                                        <div class="chitiet-product-right-transport-top-item-car">
                                            <i class="chitiet-product-right-transport-top-item-car-icon fas fa-truck"></i>
                                            <div class="chitiet-product-right-transport-top-item-car-text">
                                                <div class="chitiet-product-right-transport-top-item-car-text-top">
                                                    <div class="chitiet-product-right-transport-top-item-car-text-top-go">Vận chuyển tới</div>
                                                    <div class="chitiet-product-right-transport-top-item-car-text-top-district">
                                                        <span> Huyện Ba Vì</span>
                                                        <i class="chitiet-product-right-transport-top-item-car-text-icon fas fa-angle-down"></i>
                                                    </div>
                                                </div>
                                                <div class="chitiet-product-right-transport-top-item-car-text-bot">
                                                    <div class="chitiet-product-right-transport-top-item-car-text-bot-label">Phí Vận Chuyển</div>
                                                    <div class="chitiet-product-right-transport-top-item-car-text-bot-zeno">
                                                        ₫0
                                                        <i class="chitiet-product-right-transport-top-item-car-text-icon fas fa-angle-down"></i>
                                                    </div>
                                                </div>
                                ...
                                <div class="chitiet-product-right-transport-bot">
                                    <div class="chitiet-product-right-transport-bot-flex">
                                        <div class="chitiet-product-right-transport-bot-item">
                                            <div class="chitiet-product-right-transport-bot-item-text">Số lượng</div>
                                            <div class="chitiet-product-right-transport-bot-item-augment">
                                                <div class="chitiet-product-right-transport-bot-item-augment-quantity">
                                                    <button class="chitiet-product-right-transport-bot-item-augment-btn">
                                                        <i class="chitiet-product-right-transport-bot-item-augment-icon fas fa-minus"></i>
                                                    </button>
                                                    <input type="text" class="chitiet-product-right-transport-bot-item-augment-input" role="spinbutton" aria-valuenow="1" value="1">
                                                    <button class="chitiet-product-right-transport-bot-item-augment-btn">
                                                        <i class="chitiet-product-right-transport-bot-item-augment-icon fas fa-plus"></i>
                                                    </button>
                                                </div>
                        ...
                        <div class="chitiet-product-right-buying">
                            <button class="chitiet-product-right-buying-btn1" type="button" aria-disabled="fasle">
                                <i class="chitiet-product-right-buying-icon fas fa-cart-plus"></i>
                                <span>Thêm Vào Giỏ Hàng</span>
                            </button>
                            <button class="chitiet-product-right-buying-btn2" type="button" aria-disabled="fasle">
                                Mua Ngay
                            </button>
                        </div>
                        <div class="chitiet-product-right-end">
                            <a href="#" class="chitiet-product-right-end-item">
                                <img src="images/chitiet/khien.png" alt="" class="chitiet-product-right-end-img">
                                <span class="chitiet-product-right-end-text">Shopee Đảm Bảo</span>
            ...
            <div class="chitiet-shop">
                <div class="chitiet-shop-left">
                    <a href="#" class="chitiet-shop-left-link">
                        <div class="chitiet-shop-left-link-img">
                            <img src="images/chitiet/shop_legendary.jpg" alt="" class="chitiet-shop-left-img">
                        </div>
                        <div class="chitiet-shop-left-link-like">
                            <div class="chitiet-shop-left-link-like-text">Yêu Thích</div>
                        </div>
                    </a>
                    <div class="chitiet-shop-left-item">
                        <div class="chitiet-shop-left-item-text">legendary_official</div>
                        <div class="chitiet-shop-left-item-label">Online 6 phút trước</div>
                        <div class="chitiet-shop-left-item-link">
                            <button type="button" class="chitiet-shop-left-item-btn">
                                <i class="chitiet-shop-left-item-icon fas fa-comments"></i>
                                Chat Ngay
                            </button>
                            <a href="#" class="chitiet-shop-left-item-light">
                                <i class="chitiet-shop-left-item-light-icon far fa-calendar"></i>
                                Xem Shop
                            </a>
                        </div>
                    </div>
                </div>
                <div class="chitiet-shop-right">
                    <div class="chitiet-shop-right-item">
                        <div class="chitiet-shop-right-item-text">
                            <label class="chitiet-shop-right-item-text-label">Đánh giá</label>
                            <span class="chitiet-shop-right-item-text-span">49k</span>
                        </div>
                        <div class="chitiet-shop-right-item-text">
                            <label class="chitiet-shop-right-item-text-label">Sản Phẩm</label>
                            <span class="chitiet-shop-right-item-text-span">427</span>
                        </div>
                    </div>
                    <div class="chitiet-shop-right-item">
                        <div class="chitiet-shop-right-item-text">
                            <label class="chitiet-shop-right-item-text-label">Tỉ Lệ Phản Hồi</label>
                            <span class="chitiet-shop-right-item-text-span">96%</span>
                        </div>
                        <div class="chitiet-shop-right-item-text">
                            <label class="chitiet-shop-right-item-text-label">Thời Gian Phản Hồi</label>
                            <span class="chitiet-shop-right-item-text-span">Trong Vài Giờ</span>
                        </div>
                    </div>
                    <div class="chitiet-shop-right-item">
                        <div class="chitiet-shop-right-item-text">
                            <label class="chitiet-shop-right-item-text-label">Tham Gia</label>
                            <span class="chitiet-shop-right-item-text-span">16 tháng trước</span>
                        </div>
                        <div class="chitiet-shop-right-item-text">
                            <label class="chitiet-shop-right-item-text-label">Người Theo Dõi</label>
                            <span class="chitiet-shop-right-item-text-span">202,7k</span>
                        </div>
                    </div>
                </div>
            </div>
