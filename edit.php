                    ...
                    <div>
                        <div class="container">
                            ...
                            <div class="product-today-main product-php">
                                <h1>SỬA SẢN PHẨM</h1>
                                <br/>
			                    <form class="form label-1" action="edit_exec.php" method="post"  enctype="multipart/form-data">
                                    ...
                                    <img src="<?php echo $result["img"]?>" width="50px"/>
                                    <div class="clear-both"></div>
                                    <label>Name</label><input name="name" value=""/>
                                    <div class="clear-both"></div>
                                    <label>Discount</label><input name="discount" value=""/>
                                    <div class="clear-both"></div>
                                    <label>Price</label><input name="Price" value=""/>
                                    <div class="clear-both"></div>
                                    <label>Sold</label><input name="sold" value=""/>
                                    <div class="clear-both"></div>
                                    <label>Favourite</label>
                                    <input name="favourite" value= ""/>
                                    <div class="clear-both"></div>
                                    <label>Sale</label>
                                    <input name="sale" value=""/>
				                    <div class="clear-both"></div>
				                    <button >OK</button>
			                    </form>
                                <br/>
