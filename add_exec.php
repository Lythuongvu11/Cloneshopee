<?php
	...
	$favourite = isset($_REQUEST["favourite"]) ? $_REQUEST["favourite"] : "";
                ...
                <div class="product-today">
                    <div>
                        <div class="container">
                            ...
                            <h1>KẾT QUẢ THÊM SẢN PHẨM</h1>
			                <br/>
			                Bạn đã thêm sản phẩm thành công, bạn muốn thực hiện <a href="add.php">thêm mới</a> hay quay về <a href="search.php">danh sách bài viết</a>
			                <br/>
			                <br/>
